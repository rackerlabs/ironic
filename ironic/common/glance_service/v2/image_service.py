...
glance_opts = [
    ...
    cfg.StrOpt('swift_endpoint_url',
                help='Override the base URL for the Swift server (without '
                     ...
                     'e.g. swift.example.com'),
    cfg.StrOpt('swift_path',
                help='Override the the string between host and container, '
                     'including version string. Should not include leading'
                     'or trailing slashes. e.g. "v1/TENANT_NAME_TENANT_ID"'),
