...
class TestListDrivers(base.FunctionalTest):
    ...
    def test_driver_vendor_passthru_ok(self):
        self.register_fake_conductors()
        with mock.patch.object(rpcapi.ConductorAPI,
                               'driver_vendor_passthru') \
                                as driver_vendor_passthru:
            driver_vendor_passthru.return_value = {
            ...
            self.assertEqual(driver_vendor_passthru.return_value,
                             response.json)
