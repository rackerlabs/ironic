...
class RPCAPITestCase(base.DbTestCase):
    ...
    def test_get_random_topic_for_known_driver(self):
        CONF.set_override('host', 'fake-host')
        ...
        self.assertEqual('fake-topic.fake-host',
                         rpcapi.get_random_topic_for_driver('fake-driver'))

    def test_get_random_topic_for_unknown_driver(self):
        CONF.set_override('host', 'fake-host')
        self.dbapi.register_conductor({
            'hostname': 'fake-host',
            'drivers': ['other-driver'],
        ...
        self.assertRaises(exception.DriverNotFound,
                          rpcapi.get_random_topic_for_driver,
                          'fake-driver')
